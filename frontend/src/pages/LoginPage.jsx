      ...
      <div className="hidden lg:flex flex-1 bg-primary items-center justify-center p-12">
        <div className="max-w-md text-white text-center">
          <h2 className="text-3xl font-bold mb-4" style={{ fontFamily: 'Barlow, sans-serif' }}>
            Gestisci il tuo business con facilità
          </h2>
          <p className="text-white/80">
            Dashboard completo per installatori PPF e Wrap. Calcola le tasse, 
            traccia la profittabilità e gestisci i clienti in un unico posto.
          </p>
        </div>
      </div>
    </div>
